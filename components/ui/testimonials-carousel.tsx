...
const Section = ({ title, subtitle, children }: SectionProps) => {
    ...
    export function TestimonialsCarousel() {
        ...
        <div className="pointer-events-none absolute inset-y-0 left-0 h-full w-2/12"></div>
            <div className="pointer-events-none absolute inset-y-0 right-0 h-full  w-2/12"></div>
            </div>
