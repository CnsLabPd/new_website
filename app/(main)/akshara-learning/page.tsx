...
export const metadata: Metadata = {
  title: "Akshara | Foundational Learning by Neurogati",
  description:
    "Explore Akshara, Neurogati's personalized foundational learning platform for language, mathematics, puzzles, sensorimotor skills, our world, and life skills.",
}
...
const learningAreas = [
  ...
  },
  {
    ...
    description:
      "Counting, addition, and early numerical thinking taught through playful activities and games.",
  ...
  },
  {
    ...
    title: "Brain puzzles",
    description:
      "Engaging puzzles that support attention, problem-solving, reasoning, and curiosity.",
  ...
  },
  {
    ...
    description:
      "Activities around the body, family, nature, society, environment, Earth, and space.",
      ...
      <section className="relative overflow-hidden border-b border-border bg-background">
        ...
        <div className="container relative z-10 mx-auto grid min-h-[74svh] items-center gap-12 px-6 py-16 lg:grid-cols-[0.95fr_1.05fr] lg:px-12">
          <div className="max-w-3xl">
            <p className="mb-4 text-sm font-bold uppercase text-[#1c82c2]">Neurogati Education</p>
            <h1 className="text-5xl font-black leading-tight md:text-7xl">Akshara</h1>
            <p className="mt-5 text-2xl font-semibold leading-snug text-foreground/85 md:text-3xl">
              Personalized foundational learning for every child.
            </p>
            <p className="mt-6 max-w-2xl text-base leading-8 text-muted-foreground md:text-lg">
              Akshara is a Neurogati learning platform for children aged 3-10. It makes early learning
              enjoyable and adaptive across language, mathematics, puzzles, sensorimotor skills,
              our world, and life skills.
            </p>
        ...
        <div className="container mx-auto grid gap-10 px-6 md:grid-cols-[0.8fr_1.2fr] md:gap-16 lg:px-12">
          <div>
            ...
            <h2 className="text-3xl font-black leading-tight md:text-5xl">
              Learning that adapts to young minds.
            </h2>
          </div>
          <div className="space-y-5 text-base leading-8 text-muted-foreground md:text-lg">
            <p>
              Akshara brings together foundational learning and child-friendly interaction. It is
              designed for mainstream and special education contexts where children benefit from
              structured, repeatable, and enjoyable practice.
            </p>
            <p>
              The platform frames learning as an adventure. Children move through thematic learning
              areas while building confidence in communication, numeracy, exploration, and daily-life
              skills.
            </p>
          </div>
        </div>
      ...
      <section className="border-y border-border bg-muted/30 py-20 md:py-24">
        <div className="container mx-auto px-6 lg:px-12">
          <div className="mb-12 max-w-3xl">
            <p className="mb-3 text-sm font-bold uppercase text-[#1c82c2]">Learning areas</p>
            <h2 className="text-3xl font-black md:text-5xl">What children practise on Akshara</h2>
            <p className="mt-4 leading-7 text-muted-foreground">
              The platform combines core academic foundations with cognitive, sensorimotor, and
              everyday participation skills.
            </p>
          </div>
      ...
      <section className="py-20 md:py-28">
        <div className="container mx-auto px-6 lg:px-12">
          <div className="grid gap-10 md:grid-cols-3">
            ...
            <div className="grid gap-5 md:col-span-2 sm:grid-cols-3">
              {[
                {
                  icon: School,
