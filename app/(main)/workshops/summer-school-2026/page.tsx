...
export default function SummerSchool2026Page() {
  return (
    <div className="bg-background text-foreground min-h-screen">
      {/* HERO SECTION */}
      <section className="relative pt-48 pb-24 overflow-hidden bg-gradient-to-br from-blue-600/10 via-violet-600/10 to-background border-b border-border">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        <section className="mb-20">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl md:text-5xl font-black tracking-tighter mb-6">30+ Speakers Including</h2>
            <div className="h-1.5 w-20 bg-blue-600 mb-8"></div>
              ...
              <CardContent className="p-8">
                <div className="grid md:grid-cols-2 gap-4 text-foreground/80">
                  ...
                  <div className="flex items-start gap-2">
                    <ChevronRight className="h-5 w-5 text-violet-500 flex-shrink-0 mt-1" />
                    <div>
                      <p className="font-bold">Prof. Dipanjan Roy</p>
                      <p className="text-sm text-muted-foreground">IIT Jodhpur, India</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-2">
                    <ChevronRight className="h-5 w-5 text-violet-500 flex-shrink-0 mt-1" />
                    <div>
                      <p className="font-bold">Prof. Risto Iliomeni</p>
                      <p className="text-sm text-muted-foreground">Aalto University, Finland</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-2">
                ...
                <p className="text-center text-muted-foreground mt-6 font-bold">...and many more!</p>
              </CardContent>
            </Card>
          </div>
        </section>
