                  ...
                  <CardContent className="p-6">
                    <div className="space-y-4">
                      <div className="space-y-2">
                        <p className="font-bold text-sm text-muted-foreground uppercase">Morning Sessions</p>
                        <div className="space-y-1">
                          <p className="flex justify-between"><span>Karthik Venkataraman, Neurostellar - "Building a BCI product from 0 to 1"</span><span className="text-sm text-muted-foreground">10:00-11:00 AM</span></p>
