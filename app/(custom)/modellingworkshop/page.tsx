    ...
    <div className="min-h-screen bg-gradient-to-br from-[#050814] via-[#0a0f2c] to-[#0b163f] text-white">
      ...
      <section className="pt-40 pb-24 border-b border-white/10 text-center">
        <div className="container mx-auto px-6">
          ...
          <p className="max-w-3xl mx-auto text-xl text-slate-300 mb-10">
            From single neuron dynamics to oscillatory networks and large-scale brain system modeling.
          </p>
      ...
      <div className="container mx-auto px-6 py-24 space-y-32">
        ...
        <section id="overview" className="grid gap-8 md:grid-cols-4">
          {[
            { icon: <Brain />, title: "Single Neuron Models", desc: "HH, Morris-Lecar, FitzHugh–Nagumo, Izhikevich models" },
            { icon: <Network />, title: "Neural Networks", desc: "Deep learning & CNN applications in neuroscience" },
            { icon: <Activity />, title: "Oscillations", desc: "Phase plane analysis, rhythms & DONNs" },
            { icon: <Layers />, title: "Systems Modeling", desc: "Basal ganglia, hippocampus, fMRI network models" },
          ].map((item, idx) => (
        ...
        <section id="schedule" className="space-y-12">
          ...
          <div className="space-y-8 max-w-5xl mx-auto">
            ...
            <Card className="p-8 rounded-[2rem]">
              <h3 className="text-2xl font-black mb-6">Day 1 – Single Neuron Dynamics</h3>
            ...
            <Card className="p-8 rounded-[2rem]">
              <h3 className="text-2xl font-black mb-6">Day 2 – Neural Networks</h3>
              <ul className="space-y-2 text-muted-foreground">
            ...
            <Card className="p-8 rounded-[2rem]">
              <h3 className="text-2xl font-black mb-6">Day 3 – Oscillations</h3>
              <ul className="space-y-2 text-muted-foreground">
            ...
            <Card className="p-8 rounded-[2rem]">
              <h3 className="text-2xl font-black mb-6">Day 4 & 5 – Systems & Projects</h3>
              <ul className="space-y-2 text-muted-foreground">
