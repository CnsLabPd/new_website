    ...
    <div className="min-h-screen bg-gradient-to-br from-[#050814] via-[#0a0f2c] to-[#0b163f] text-white">
      ...
      <section id="testimonials" className="container mx-auto px-6 py-28">
        <div className="text-center mb-16">
          ...
          <p className="text-slate-400">Anonymous feedback from previous participants</p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {[
            ...
            "As a bachelor's student in neuroscience, this was the most helpful and useful learning experience I've had.",
...
function TestimonialCard({ text }: { text: string }) {
  return (
    <Card className="p-8 rounded-3xl bg-gradient-to-br from-white/5 to-white/[0.02] border border-white/10 backdrop-blur-md hover:border-cyan-400/40 transition-all duration-300">
