...
export const NIRA_SITE_PAGES: SitePage[] = [
  ...
  { path: "/movement-and-games", label: "Movement & Games", keywords: ["movement", "games", "products", "platform", "qumon", "cp clinic", "movement platform", "gaming"] },
  { path: "/products", label: "Movement & Games redirect", keywords: ["products", "applications", "movement", "games", "platform"] },
  ...
  { path: "/games", label: "Gaming Platform", keywords: ["games", "gaming", "platform", "rehabilitation", "exergames", "therapy", "crgs"] },
  { path: "/cp-clinic", label: "CP Clinic Platform", keywords: ["cp", "cerebral palsy", "clinic", "gait", "movement", "home monitoring", "clinical", "therapy", "pose estimation", "longitudinal", "motor monitoring"] },
  { path: "/movement-platform", label: "Movement Platform", keywords: ["movement", "platform", "analysis", "assessment", "tracking", "rehabilitation", "coming soon"] },
  { path: "/neuroshiksha", label: "Neuroshiksha foundational learning", keywords: ["neuroshiksha", "neurosiksha", "akshara", "children", "kids", "language", "tamil", "english", "math", "puzzles", "special education", "life skills", "foundational learning"] },
  { path: "/akshara-learning", label: "Akshara redirect to Neuroshiksha", keywords: ["akshara", "neuroshiksha", "children", "foundational learning"] },
